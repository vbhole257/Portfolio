...
export async function POST(request: Request) {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      ...
      secure: true,
      auth: {
        user: process.env.SMTP_EMAIL || 'vbhole257@gmail.com',
    ...
    await transporter.sendMail({
      from: `"Portfolio Contact" <${process.env.SMTP_EMAIL || 'vbhole257@gmail.com'}>`,
      to: 'vbhole257@gmail.com', // The destination inbox remains your main ID!
