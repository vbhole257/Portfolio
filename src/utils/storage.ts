/**
 * Safe wrapper around sessionStorage and localStorage to prevent crashes in sandboxed environments,
...
export const safeLocalStorage = {
  getItem(key: string): string | null {
    try {
      ...
      console.warn(`[localStorage] Failed to get key "${key}":`, e);
    }
    return null;
  },
  ...
  setItem(key: string, value: string): void {
    try {
      ...
      console.warn(`[localStorage] Failed to set key "${key}":`, e);
    }
  },
