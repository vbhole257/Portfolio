...
export default function RecruiterHubModal({ isOpen, onClose }: RecruiterHubModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md animate-fadeIn">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-2xl bg-cream dark:bg-ink border border-charcoal/20 dark:border-white/15 rounded-3xl p-6 sm:p-8 shadow-2xl overflow-hidden text-charcoal dark:text-cream z-10">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-charcoal/10 dark:border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-mono text-lg font-black uppercase tracking-wide">Recruiter Fast-Track Hub</h2>
              <p className="text-xs text-gray-soft font-mono">1-Click candidate summary & direct contact</p>
            </div>
          </div>
          <button
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-accent/10 border border-accent/25 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h3 className="font-mono font-bold text-sm text-accent uppercase tracking-wider">Official Resume (PDF)</h3>
              <p className="text-xs text-charcoal/80 dark:text-cream/80 mt-1 font-sans">
            ...
            <a
              ...
              onMouseEnter={playHoverSound}
              className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-accent text-white font-mono text-xs font-bold uppercase tracking-wider hover:bg-accent/90 transition-all shadow-lg shadow-accent/20 hover:scale-[1.02] active:scale-[0.98] shrink-0"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-4 rounded-xl bg-charcoal/5 dark:bg-white/5 border border-charcoal/10 dark:border-white/10 space-y-1">
              <span className="font-mono text-[11px] uppercase tracking-wider text-gray-soft">Experience & Role</span>
            ...
            <div className="p-4 rounded-xl bg-charcoal/5 dark:bg-white/5 border border-charcoal/10 dark:border-white/10 space-y-1">
              <span className="font-mono text-[11px] uppercase tracking-wider text-gray-soft">Core Stack</span>
          ...
          <div className="space-y-2">
            <h4 className="font-mono text-xs font-bold uppercase tracking-wider text-gray-soft">30-Second Qualification Highlights</h4>
          ...
          <div className="pt-2 border-t border-charcoal/10 dark:border-white/10 flex flex-wrap gap-2">
            <button
              ...
              onMouseEnter={playHoverSound}
              className="flex-1 min-w-[140px] inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-charcoal/5 dark:bg-white/5 hover:bg-charcoal/10 dark:hover:bg-white/10 border border-charcoal/10 dark:border-white/10 font-mono text-xs transition-colors"
            >
            ...
            <a
              ...
              onClick={playClickSound}
              onMouseEnter={playHoverSound}
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-charcoal/5 dark:bg-white/5 hover:bg-charcoal/10 dark:hover:bg-white/10 border border-charcoal/10 dark:border-white/10 font-mono text-xs transition-colors"
            >
